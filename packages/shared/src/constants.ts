...
export const defaultGradient = [
  primaryColors["--color-primary-900"],
  primaryColors["--color-primary-800"],
] as const;
...
export const tables = {
  ...
  group_member_invites: "group_member_invites",
  messages: "messages",
...
export const mockLocationBonaberi = {
  latitude: 4.086168,
  longitude: 9.656306,
  altitude: null,
  accuracy: 5,
...
export const mockLocationYassa = {
  latitude: 3.994943,
  longitude: 9.784966,
  altitude: null,
  accuracy: 5,
